  ...
  return (
    <header className="bg-background border-b border-border sticky top-0 z-50 shadow-sm">
      <div className="flex items-center justify-between h-16 px-4 lg:px-6">
        ...
        <div className="flex items-center space-x-4">
          {/* Mobile search button */}
          <button className="md:hidden p-2 rounded-md text-muted-foreground hover:text-foreground hover:bg-accent transition-colors">
            <Search className="h-5 w-5" />
          </button>
          ...
          <div className="relative">
            ...
            {/* Dropdown menu */}
            {userMenuOpen && (
              <div className="absolute right-0 mt-2 w-56 bg-card rounded-md shadow-lg ring-1 ring-border z-50">
                <div className="py-1">
                  {/* User info - mobile only */}
