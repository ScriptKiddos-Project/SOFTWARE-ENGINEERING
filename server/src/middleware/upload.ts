...
export const validateFile = {
  ...
  isImage: (file: Express.Multer.File): boolean => {
    return UPLOAD_CONFIG.ALLOWED_IMAGE_TYPES.includes(file.mimetype as typeof UPLOAD_CONFIG.ALLOWED_IMAGE_TYPES[number]);
  },
  
  // Check if file is document
  isDocument: (file: Express.Multer.File): boolean => {
    return UPLOAD_CONFIG.ALLOWED_DOCUMENT_TYPES.includes(file.mimetype as typeof UPLOAD_CONFIG.ALLOWED_DOCUMENT_TYPES[number]);
  },
